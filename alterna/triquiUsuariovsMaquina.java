 ...
 * @author Yenifer
 */
public class TriquiUsuariovsMaquina {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("Escoja una opción para empezar el juego: \n 1. usuario1 vs usuario2 \n 2. usuario vs maquina \n 3. Puntajes \n 4.Salir de Juego");
            elegir = leer.nextInt();// variable que guarda la información de que opción del juego elige el usuario
    ...
    }//Método para poner las marcas, valida y muestra quien gana
    ...
    public static void mostrarMatriz(char[][] matriz) {
        ...
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[0].length; j++) {
                ...
                }//Imprime matriz vacía

            }

        }

    }//fin método mostratMatriz
